...
class DeriveFrontendAndBackendSystemFromFeatureBCCommandTest extends AbstractCMLCommandTest {
	...
	def void testARCommandExecution() {
		...
		refactoringParams.add("TestFeatureContext")
		refactoringParams.add(ContextSplittingIntegrationType.CONFORMIST.toString)
		val result = languageServer.executeCommand(
			new ExecuteCommandParams("cml.ar.deriveFrontendBackendSystemsFromFeatureBC",
