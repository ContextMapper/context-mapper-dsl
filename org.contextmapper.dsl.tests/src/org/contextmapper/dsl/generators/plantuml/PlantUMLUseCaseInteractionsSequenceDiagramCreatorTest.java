...
class PlantUMLUseCaseInteractionsSequenceDiagramCreatorTest extends AbstractCMLInputFileTest {
	...
	public void canCreateSequenceDiagram4UseCaseInteractions() throws IOException {
		...
		assertEquals("@startuml" + System.lineSeparator()
				...
				+ "  Note: This diagram aims to illustrate" + System.lineSeparator()
				+ "  interactions of a use case in an early analysis state." + System.lineSeparator()
				+ "  We are aware that some interactions might not be" + System.lineSeparator()
				+ "  triggered/connected by/with the correct actor(s)" + System.lineSeparator()
				+ "  (known limitation)." + System.lineSeparator()
