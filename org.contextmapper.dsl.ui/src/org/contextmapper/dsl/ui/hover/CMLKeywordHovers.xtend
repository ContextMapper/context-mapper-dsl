...
class CMLKeywordHovers {
	...
	def initHoverMap() {
		...
		hoverTextMap.put("ContextMap", '''<strong>Context Map</strong>: A model describing bounded contexts 
		...
		hoverTextMap.put("U", '''<strong>U</strong>pstream in the upstream-downstream relationship.
		...
		hoverTextMap.put("D", '''<strong>D</strong>ownstream in the upstream-downstream relationship.
		<br/><br/><strong>upstream-downstream</strong>:<br/>A relationship between two bounded contexts 
		in which the “upstream” contexts’s actions affect project success of the “downstream” context, but 
		the actions of the downstream do not significantly affect projects upstream. (e.g. If two cities 
		are along the same river, the upstream city’s pollution primarily affects the downstream city.) 
		...
		hoverTextMap.put("S", '''<strong>S</strong>upplier in the customer-supplier relationship.
		...
		hoverTextMap.put("C", '''<strong>C</strong>ustomer in the customer-supplier relationship.
		<br/><br/><strong>customer-supplier</strong>:<br/>Describes an upstream-downstream relationship 
		where one bounded context is customer and the other supplier which work closely together. 
		The supplier prioritizes the implementation with respect to the customers requirements.
		<br/><br/> Find all DDD pattern descriptions in the DDD reference under 
		...
		hoverTextMap.put("OHS", '''<strong>Open Host Service (OHS)</strong>: Describes a role of a 
		...
		hoverTextMap.put("PL", '''<strong>Published Language (PL)</strong>: The published language describes 
		...
		hoverTextMap.put("ACL", '''<strong>Anticorruption Layer (ACL)</strong>: Describes a mechanism used 
		by downstreams in order to protect themselves from changes of the upstream.
		<br/><br/> Find all DDD pattern descriptions in the DDD reference under 
		<a href="http://domainlanguage.com/ddd/reference/">http://domainlanguage.com/ddd/reference/</a>''');
		
		hoverTextMap.put("CF", '''<strong>Conformist (CF)</strong>: Describes a role of a bounded context in 
		...
		hoverTextMap.put("Aggregate", '''<strong>Aggregate</strong>: An Aggregate is a cluster of domain 
		...
		hoverTextMap.put("Domain", '''<strong>Domain</strong>: The domain describes the world within your 
		...
		hoverTextMap.put("Subdomain", '''<strong>Subdomain (Core, Supporting, Generic)</strong>: A subdomain 
		...
		hoverTextMap.put("P", '''<strong>Partnership (P)</strong>: The partnership pattern describes an 
		intimate relationship between two bounded contexts. Their domain models somehow relate and have 
		to be evolved together.
		<br/><br/> Find all DDD pattern descriptions in the DDD reference under 
		<a href="http://domainlanguage.com/ddd/reference/">http://domainlanguage.com/ddd/reference/</a>''');
		
		hoverTextMap.put("SK", '''<strong>Shared Kernel (SK)</strong>: Desribes an intimate relationship 
