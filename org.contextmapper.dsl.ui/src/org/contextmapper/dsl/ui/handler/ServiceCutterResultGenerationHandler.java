...
import org.contextmapper.dsl.generator.ServiceCutterResultGenerator;
...
public class ServiceCutterResultGenerationHandler extends AbstractHandler implements IHandler {

	@Inject
	private ServiceCutterResultGenerator generator;
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (firstElement instanceof IFile) {
				...
				try {
					generator.doGenerate(jsonFile.getFullPath().toFile());
