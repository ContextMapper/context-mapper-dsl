...
public class DeriveFrontendAndBackendFromFeatureBCCommand extends AbstractRefactoringCommand {

	public DeriveFrontendAndBackendFromFeatureBCCommand(WorkspaceEditRecorder editRecorder) {
		super(editRecorder);
	}
	...
	protected SemanticCMLRefactoring getRefactoring(ExecuteCommandParams params) {
		...
		JsonPrimitive integrationType = (JsonPrimitive) refactoringParams.get(1);

		return new DeriveFrontendAndBackendSystemsFromFeature(boundedContextName.getAsString(), ContextSplittingIntegrationType.valueOf(integrationType.getAsString()));
	}
