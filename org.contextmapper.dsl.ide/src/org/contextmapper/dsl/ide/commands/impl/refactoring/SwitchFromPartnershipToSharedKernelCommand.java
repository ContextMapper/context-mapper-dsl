...
public class SwitchFromPartnershipToSharedKernelCommand extends AbstractRefactoringCommand {

	public SwitchFromPartnershipToSharedKernelCommand(WorkspaceEditRecorder editRecorder) {
		super(editRecorder);
	}
	...
	protected SemanticCMLRefactoring getRefactoring(ExecuteCommandParams params) {
		...
		return new SwitchFromPartnershipToSharedKernelRefactoring(participant1.getAsString(), participant2.getAsString());
	}
