 ...
 *
 */
public class ServiceCutterUserRepresentationExampleFileGenerationCommand extends AbstractGenerationCommand {

	@Override
	IGenerator2 getGenerator() {
		return new ServiceCutterUserRepresentationsExampleGenerator();
	}
