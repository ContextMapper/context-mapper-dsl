...
public class AddEthicalValueAssessmentCommand extends AbstractRefactoringCommand {

	public AddEthicalValueAssessmentCommand(WorkspaceEditRecorder editRecorder) {
		super(editRecorder);
	}
	...
	protected SemanticCMLRefactoring getRefactoring(ExecuteCommandParams params) {
		...
		return new AddEthicalValueAssessmentToStory(userStoryName.getAsString());
	}
