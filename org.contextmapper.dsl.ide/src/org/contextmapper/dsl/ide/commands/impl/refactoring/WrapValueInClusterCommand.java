...
public class WrapValueInClusterCommand extends AbstractRefactoringCommand {
	...
	public WrapValueInClusterCommand(WorkspaceEditRecorder editRecorder) {
		super(editRecorder);
	}
	...
	protected SemanticCMLRefactoring getRefactoring(ExecuteCommandParams params) {
		...
		JsonPrimitive valueName = (JsonPrimitive) refactoringParams.get(0);
		return new WrapValueInClusterRefactoring(valueName.getAsString());
	}
