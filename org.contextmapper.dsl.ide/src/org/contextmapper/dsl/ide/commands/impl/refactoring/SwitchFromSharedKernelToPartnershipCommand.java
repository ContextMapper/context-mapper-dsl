...
public class SwitchFromSharedKernelToPartnershipCommand extends AbstractRefactoringCommand {

	public SwitchFromSharedKernelToPartnershipCommand(WorkspaceEditRecorder editRecorder) {
		super(editRecorder);
	}
	...
	protected SemanticCMLRefactoring getRefactoring(ExecuteCommandParams params) {
		...
		return new SwitchFromSharedKernelToPartnershipRefactoring(participant1.getAsString(), participant2.getAsString());
	}
