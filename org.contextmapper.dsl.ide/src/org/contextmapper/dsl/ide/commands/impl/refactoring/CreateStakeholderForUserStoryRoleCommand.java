...
public class CreateStakeholderForUserStoryRoleCommand extends AbstractRefactoringCommand {

	public CreateStakeholderForUserStoryRoleCommand(WorkspaceEditRecorder editRecorder) {
		super(editRecorder);
	}
	...
	protected SemanticCMLRefactoring getRefactoring(ExecuteCommandParams params) {
		...
		JsonPrimitive userStoryName = (JsonPrimitive) refactoringParams.get(0);
		return new CreateStakeholderForUserStoryRole(userStoryName.getAsString());
	}
