 ...
 *
 */
public abstract class AbstractGenerationCommand implements SCLResourceCommand {
	...
	@Override
	public void executeCommand(SCLResourceContainer sclResource, Document document, ILanguageServerAccess access, ExecuteCommandParams params) {
		getGenerator().doGenerate(sclResource.getResource(), getFileSystemAccess(), new GeneratorContext());
	}
