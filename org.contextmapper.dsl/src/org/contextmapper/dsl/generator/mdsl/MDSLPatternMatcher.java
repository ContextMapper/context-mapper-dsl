...
public class MDSLPatternMatcher {
	...
	public static final String[] ENDPOINT_SERVES_AS_PATTERNS = { "PROCESSING_RESOURCE", "INFORMATION_HOLDER_RESOURCE", "OPERATIONAL_DATA_HOLDER", "MASTER_DATA_HOLDER",
			"REFERENCE_DATA_HOLDER", "TRANSFER_RESOURCE", "LOOKUP_RESOURCE", "DATA_TRANSFER_RESOURCE", "LINK_LOOKUP_RESOURCE", "GATEWAY_RESOURCE", "COMPOSITION_RESOURCE",
			"GUARD_RESOURCE", "GROUND_RESOURCE" };

	public static final String[] OPERATION_RESPONSIBILITY_PATTERNS = { "COMPUTATION_FUNCTION", "NOTIFICATION_OPERATION", "RETRIEVAL_OPERATION", "STATE_TRANSITION_OPERATION",
